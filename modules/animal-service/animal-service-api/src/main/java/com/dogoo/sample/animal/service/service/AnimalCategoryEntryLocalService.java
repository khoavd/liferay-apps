...
/**
 * Provides the local service interface for AnimalCategoryEntry. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see AnimalCategoryEntryLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface AnimalCategoryEntryLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.dogoo.sample.animal.service.service.impl.AnimalCategoryEntryLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the animal category entry local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link AnimalCategoryEntryLocalServiceUtil} if injection and service tracking are not available.
	 */
