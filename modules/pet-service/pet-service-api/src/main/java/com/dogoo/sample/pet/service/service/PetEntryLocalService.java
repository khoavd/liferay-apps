...
public interface PetEntryLocalService
	...
	public void addAnimalTagEntryPetEntry(long animalTagId, PetEntry petEntry);
	...
	public PetEntry addPetEntry(
		long customerId, long creatorId, PetMapperModel petMapperModel,
	...
	public void deleteAnimalTagEntryPetEntries(long animalTagId, long[] petIds);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public PetEntry fetchPetEntryByExternalReferenceCode(
	...
	@Deprecated
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public PetEntry fetchPetEntryByReferenceCode(
		long companyId, String externalReferenceCode);
	...
	public List<PetEntry> findByName(long customerId, String name);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ActionableDynamicQuery getActionableDynamicQuery();

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<PetEntry> getAnimalTagEntryPetEntries(long animalTagId);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<PetEntry> getByVaccine(long customerId, boolean vaccine);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public PetEntry getPetEntryByExternalReferenceCode(
			long companyId, String externalReferenceCode)
		throws PortalException;
	...
	@Indexable(type = IndexableType.REINDEX)
	public PetEntry removeAnimalGroup(
			long creatorId, long entryId, ServiceContext context)
		throws PortalException;
	...
	public void removeAnimalGroupBatch(
			long creatorId, long[] entryIds, ServiceContext context)
		throws PortalException;
	...
	public PetEntry updatePetEntry(
			long creatorId, long entryId, PetMapperModel petMapperModel,
			ServiceContext context)
		throws PortalException;
