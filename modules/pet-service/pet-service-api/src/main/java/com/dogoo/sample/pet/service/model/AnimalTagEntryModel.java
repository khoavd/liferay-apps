...
/**
 * The base model interface for the AnimalTagEntry service. Represents a row in the &quot;DG_ANIMALTAG&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.dogoo.sample.pet.service.model.impl.AnimalTagEntryModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.dogoo.sample.pet.service.model.impl.AnimalTagEntryImpl</code>.
 * </p>
 *
 * @author khoavu
 * @see AnimalTagEntry
 ...
 */
@ProviderType
public interface AnimalTagEntryModel
	extends BaseModel<AnimalTagEntry>, GroupedModel, ShardedModel,
			StagedAuditedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a animal tag entry model instance should use the {@link AnimalTagEntry} interface instead.
	 */
