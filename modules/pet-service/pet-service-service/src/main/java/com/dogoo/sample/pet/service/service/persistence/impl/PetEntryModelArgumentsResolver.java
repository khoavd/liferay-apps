...
/**
 * The arguments resolver class for retrieving value from PetEntry.
 *
 * @author khoavu
 * @generated
 */
@Component(
	immediate = true,
	service = {PetEntryModelArgumentsResolver.class, ArgumentsResolver.class}
)
public class PetEntryModelArgumentsResolver implements ArgumentsResolver {
	...
	public Object[] getArguments(
		...
		if (finderPathColumnBitmask == null) {
			...
			for (String columnName : columnNames) {
				finderPathColumnBitmask |= petEntryModelImpl.getColumnBitmask(
					columnName);
			}

			if (finderPath.isBaseModelResult() &&
				(PetEntryPersistenceImpl.
