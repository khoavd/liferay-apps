...
public interface CatEntryLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.dogoo.poc.upgradeservice.cat.service.service.impl.CatEntryLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the cat entry local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link CatEntryLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public CatEntry createCatEntry(long catId);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public CatEntry deleteCatEntry(long catId) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CatEntry fetchCatEntry(long catId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CatEntry getCatEntry(long catId) throws PortalException;
