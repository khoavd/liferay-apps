 ...
 * <code>com.dogoo.poc.upgradeservice.cat.service.service.impl.CatEntryLocalServiceImpl</code> and
...
public class CatEntryLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.dogoo.poc.upgradeservice.cat.service.service.impl.CatEntryLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static CatEntry createCatEntry(long catId) {
		return getService().createCatEntry(catId);
	}
	 ...
	 */
	public static CatEntry deleteCatEntry(long catId) throws PortalException {
		return getService().deleteCatEntry(catId);
	}
	...
	public static CatEntry fetchCatEntry(long catId) {
		return getService().fetchCatEntry(catId);
	}
	 ...
	 * @throws PortalException if a cat entry with the primary key could not be found
	 */
	public static CatEntry getCatEntry(long catId) throws PortalException {
		return getService().getCatEntry(catId);
	}
