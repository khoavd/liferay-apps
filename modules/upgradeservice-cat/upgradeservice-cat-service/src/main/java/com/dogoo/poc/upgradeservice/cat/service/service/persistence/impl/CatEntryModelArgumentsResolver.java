...
/**
 * The arguments resolver class for retrieving value from CatEntry.
 *
...
@Component(
	immediate = true,
	service = {CatEntryModelArgumentsResolver.class, ArgumentsResolver.class}
)
public class CatEntryModelArgumentsResolver implements ArgumentsResolver {
	...
	public Object[] getArguments(
		...
		if (finderPathColumnBitmask == null) {
			...
			for (String columnName : columnNames) {
				finderPathColumnBitmask |= catEntryModelImpl.getColumnBitmask(
					columnName);
			}
