 ...
 */
@Generated("")
@GraphQLName(description = "Exception Type", value = "ExceptionType")
...
public class ExceptionType implements Serializable {
	...
	public static ExceptionType toDTO(String json) {
		return ObjectMapperUtil.readValue(ExceptionType.class, json);
	}

	public static ExceptionType unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(ExceptionType.class, json);
	}
	...
	@Schema(
		...
		defaultValue = "com.dogoo.sample.pet.rest.dto.v2_0.ExceptionType",
		name = "x-class-name"
	)
