...
public interface DogResource {
	...
	public Response postDogBatch(String callbackURL, Object object)
		throws Exception;

	public void deleteDog(Long dogId) throws Exception;

	public Response deleteDogBatch(String callbackURL, Object object)
		throws Exception;
	...
	public Response putDogBatch(String callbackURL, Object object)
		throws Exception;

	public DogApproval putDogApproval(
			Long dogApprovalId, DogApproval dogApproval)
		throws Exception;

	public void deleteDogByExternalReferenceCode(String externalReferenceCode)
		throws Exception;

	public Dog getDogByExternalReferenceCode(String externalReferenceCode)
		throws Exception;

	public Dog putDogByExternalReferenceCode(
			String externalReferenceCode, Dog dog)
		throws Exception;

	public DogApproval putDogApprovalByExternalReferenceCode(
			String externalReferenceCode, DogApproval dogApproval)
		throws Exception;
