 ...
 */
@Generated("")
@GraphQLName(description = "Pet model", value = "Pet")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "Pet")
public class Pet implements Serializable {

	public static Pet toDTO(String json) {
		return ObjectMapperUtil.readValue(Pet.class, json);
	}

	public static Pet unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(Pet.class, json);
	}
	...
	@Schema
	public Long[] getAnimalTagIds() {
		return animalTagIds;
	}

	public void setAnimalTagIds(Long[] animalTagIds) {
		this.animalTagIds = animalTagIds;
	}

	@JsonIgnore
	public void setAnimalTagIds(
		UnsafeSupplier<Long[], Exception> animalTagIdsUnsafeSupplier) {

		try {
			animalTagIds = animalTagIdsUnsafeSupplier.get();
		}
		catch (RuntimeException re) {
			throw re;
		}
	...
	public String toString() {
		...
		if (animalTagIds != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}

			sb.append("\"animalTagIds\": ");

			sb.append("[");

			for (int i = 0; i < animalTagIds.length; i++) {
				sb.append(animalTagIds[i]);

				if ((i + 1) < animalTagIds.length) {
					sb.append(", ");
				}
			}
	...
	@Schema(
		...
		defaultValue = "com.dogoo.sample.pet.rest.dto.v2_0.Pet",
		name = "x-class-name"
	)
