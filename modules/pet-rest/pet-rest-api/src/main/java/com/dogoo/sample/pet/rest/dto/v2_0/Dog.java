 ...
 */
@Generated("")
@GraphQLName(description = "Dog model", value = "Dog")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "Dog")
public class Dog implements Serializable {

	public static Dog toDTO(String json) {
		return ObjectMapperUtil.readValue(Dog.class, json);
	}

	public static Dog unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(Dog.class, json);
	}
	...
	@JsonIgnore
	public void setAnimalGroup(
		UnsafeSupplier<AnimalGroup, Exception> animalGroupUnsafeSupplier) {

		try {
			animalGroup = animalGroupUnsafeSupplier.get();
		}
	...
	@JsonIgnore
	public void setAnimalGroupId(
		UnsafeSupplier<Long, Exception> animalGroupIdUnsafeSupplier) {

		try {
			animalGroupId = animalGroupIdUnsafeSupplier.get();
		}
		catch (RuntimeException re) {
			throw re;
		}
	...
	protected Long animalGroupId;

	@Schema
	public String[] getAnimalTagNames() {
		return animalTagNames;
	}

	public void setAnimalTagNames(String[] animalTagNames) {
		this.animalTagNames = animalTagNames;
	}

	@JsonIgnore
	public void setAnimalTagNames(
		UnsafeSupplier<String[], Exception> animalTagNamesUnsafeSupplier) {

		try {
			animalTagNames = animalTagNamesUnsafeSupplier.get();
		}
		catch (RuntimeException re) {
			throw re;
		}
	...
	@GraphQLField
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	protected String[] animalTagNames;
	...
	public boolean equals(Object object) {
		...
		return Objects.equals(toString(), dog.toString());
	}
	...
	public String toString() {
		...
		if (animalGroup != null) {
			...
			sb.append(String.valueOf(animalGroup));
		}
		...
		if (animalTagNames != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}

			sb.append("\"animalTagNames\": ");

			sb.append("[");

			for (int i = 0; i < animalTagNames.length; i++) {
				sb.append("\"");

				sb.append(_escape(animalTagNames[i]));

				sb.append("\"");

				if ((i + 1) < animalTagNames.length) {
					sb.append(", ");
				}
			}
	...
	@Schema(
		...
		defaultValue = "com.dogoo.sample.pet.rest.dto.v2_0.Dog",
		name = "x-class-name"
	)
